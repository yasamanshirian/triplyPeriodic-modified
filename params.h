...
class params
{
  ...
  double filter_size_,filterX_start_,filterY_start_,filterZ_start_; //size of the filter ( width)
 ...
 public:
  ...
  double filterX_start() const{return filterX_start_;}
  double filterY_start() const{return filterY_start_;}
  double filterZ_start() const{return filterZ_start_;}
